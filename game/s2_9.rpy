label s2_9:
    ...
    staff_th  "ถ้าทั้งสองผ่านบททดสอบของเราได้ก็จะถือว่าทั้งคู่เป็นแฟนกันจริงๆ" with dissolve
    ...
    staff_en  "Next question: If you two had a child, what would you name them?" with dissolve
    ...
    staff_en  "Next, sir, what is your girlfriend's bust size?" with dissolve
    ...
    en "My feet have reached the final boss, the last activity: a sweet photo booth for couples." with dissolve
    hide maya_c2
    th "ปกติผมถ่ายแต่รูปวิวทิวทัศน์ ไม่ค่อยได้ถ่ายรูปคน มาถ่ายรูปคู่แบบนี้ต้องทำตัวยังไงดีเนี่ย" with dissolve
    en "Usually, I only take pictures of scenery, not people. How should I pose for a couple photo like this?" with dissolve
    ...
    yuma_en  "Whatever plan you use won't work..." with dissolve
    hide purikura03
    ...
    maya_c2_en  "Don't complain so much, you're a man. Alright, it's almost time." with dissolve
    hide purikura06
    show white with dissolve
    th "ทันใดนั้นก็มีแสงชีตเตอร์จากกล้องออกมา" with dissolve
    en "Suddenly, there was a flash from the camera." with dissolve
    hide white
    show purikura07 with dissolve
    th "หลังจากนั้นกล้องก็ทำการบันทึกรูปถ่ายของเรา" with dissolve
    en "Then the camera recorded our photo." with dissolve
    hide purikura07
    ...
    en "I guess it's suitable for a couple who've been rivals since their past lives." with dissolve
    scene life_shoppingmall1_noon with Dissolve(1.0)
    show maya_c2 normal at center with Dissolve(0.2) 
    ...
    en "In the end, I realized this was clearly a trap." with dissolve
    ...
    en "To be honest, I wanted to say it took too long, but I better not." with dissolve
    ...
    en "While I was heading home, I stumbled upon a strange-looking book." with dissolve
    hide student card
    show book00 with dissolve
    ...
    en "But for some reason, this book seems to have something that draws me to pick it up." with dissolve
    yuma_th  "เอากลับบ้านไปจะโดนยูโนะด่าไหมเนี่ย" with dissolve
    yuma_en  "If I take it home, will Yuno scold me?" with dissolve
