label s2_3:
    ...
    #to do
    # play sound "audio/sfx/เสียงออด.mp3"
    th "เสียงออดดังขึ้นหลังจบคาบเรียนที่ 4" with dissolve
    en "The bell rings after the fourth period ends." with dissolve
    th "ขณะนี้เป็นเวลาพักเที่ยง นักเรียนบางส่วนคุยเล่น บางส่วนไปห้องสมุด บางส่วนไปที่โรงอาหาร" with dissolve
    en "It's now lunchtime. Some students chat, others head to the library, and some go to the cafeteria." with dissolve
    th "ส่วนผมแวะซื้อเครื่องดื่มที่ตู้แมวน้ำบิน และไปที่ห้องสภานักเรียน" with dissolve
    ...
    #todo
    # play sound "audio/sfx/door school.mp3"
    ...
    reika_en ah_2 "Yuma, I heard you were late this morning?" with dissolve
    ...
    kazuma_en  "Try using some common sense. Arriving at 8:29:59 is practically no different from being late." with dissolve
    yuma_th  "คอมมอนเซนส์ของแต่ละคนแตกต่างกัน แต่กฎก็คือกฎ จริงมั้ยอากาเนะ" with dissolve
    yuma_en  "Common sense differs from person to person. But rules are rules, right, Akane?" with dissolve
    hide kazuma 
    hide reika
    ...
    akane_en ah "Although I don't quite agree with Senior Yuma, he's correct. The school rules state that students must arrive by 8:30 AM." with dissolve
    ...
    en "Excellent! That's how it should be. Now it's two against one. What do you say, Kasuma?" with dissolve
    th "ผมยิ้มแบบมีเล่ห์นัย ในขณะที่คาสึมะกำลังกำหมัด" with dissolve
    en "I smile mischievously while Kasuma clenches his fist." with dissolve
    show reika normal at center with Dissolve(1.0) 
    ...
    en "Reka intervenes in the heated discussion." with dissolve
    ...
    reika_en angry "Not so fast, Yuma. Are you forgetting something? Reka counters." with dissolve
    ...
    reika_en  "Social norms aren't just about laws or rules. There are also customs and social conventions." with dissolve
    ...
    reika_en  "Kasuma, tell me how one gets elected to the student council." with dissolve
    show kazuma normal at left with Dissolve(1.0) 
    show reika normal at right with Dissolve(1.0) 
    ...
    reika_en  "Yuma, you're part of the student council. If other students see you almost being late, you might be gossiped about." with dissolve
    ...
    yuma_en  "I understand. I'll be more careful next time, I concede." with dissolve
    th "สถานการณ์ตอนนี้กลับเป็น 1 ต่อ 3 ซะงั้น ไม่มีใครอยู่ฝั่งผมเลย" with dissolve
    en "Now the situation is 1 to 3. No one's on my side. How did this happen?" with dissolve
    hide akane
    ...
    kazuma_en ah "We've finished counting, ma'am. The majority voted in favor of banning soda sales in school, Reka reports." with dissolve
    ...
    kazuma_en normal "82\% agreed with banning soda sales, for reasons similar to what Reka presented on stage the other day." with dissolve
    ...
    risa_en normal "Excellent. I'll announce the voting results now, Teacher Risa says." with dissolve
    ...
    akane_en smile "It would be nice to take a break once in a while, Reka agrees." with dissolve
    ...
    th "………" with dissolve
    en "..." with dissolve
    th "Background - ห้องเรียน" with dissolve
    en "Background - Classroom" with dissolve
    ...
    en "After Reka and I enter the classroom, it seems our classmates are discussing the ban on soda sales in school." with dissolve
    ...
    student_m_a_en  "Maybe if you shake orange juice, it'll feel fizzy like soda?" with dissolve
    student_m_b_th  "มันจะเป็นแบบนั้นได้ไงเล่า!" with dissolve
    student_m_b_en  "That's not how it works!" with dissolve
    student_m_b_th  "ฉันว่าบางทีนายอาจจะเสพติดน้ำอัดลมมากเกินไปแล้วจริงๆ ก็ได้" with dissolve
    student_m_b_en  "I think you might be too addicted to soda, honestly." with dissolve
    th "ดูเหมือนสมาชิกชมรมกีฬาจะไม่เห็นด้วยกับการยกเลิกน้ำอัดลม" with dissolve
    en "It seems the sports club members disagree with the soda ban." with dissolve
    student_f_a_th  "จะยกเลิกหรือไม่ยกเลิกสำหรับฉันมันก็ไม่ได้มีผลอะไรอยู่แล้ว ก็ฉันดื่มแต่น้ำแร่นี่นา" with dissolve
    student_f_a_en  "Whether they ban it or not doesn't affect me. I only drink mineral water anyway." with dissolve
    student_f_b_th  "แต่ฉันว่ามันก็เป็นเรื่องที่ดีนะที่ทำให้น้ำอัดลมเข้าถึงได้ยากในพื้นที่โรงเรียน บางทีอาจจะช่วยให้นักเรียนหลายคนเลิกกินน้ำอัดลมได้จริงๆ ก็ได้" with dissolve
    ...
    # play sound "audio/sfx/[SFX - เสียงออดดัง].mp3"
    ...
    en "Reka dismisses me and turns back to focus on the lesson." with dissolve
    hide reika
