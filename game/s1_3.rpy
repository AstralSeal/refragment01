label s1_3:
    ...
    en "I denied hesitantly." with dissolve
    ...
    voice "audio/voice/reika/chapter1/chapter1_3/reika_1_3_006.mp3"
    ...
    yuma_en  "Yes, yes. I understand." with dissolve
    hide reika
    th "พอพูดจบ พวกเราทั้งสองคนก็เดินเข้าห้องเรียน" with dissolve
    en "After saying that, we both walked back into the classroom." with dissolve
    scene school_classroom_noon with Dissolve(1.0)
    stop music
    play music "audio/bgm/MusMus-BGM-139.mp3" volume 0.5
    show reika normal at center with Dissolve(1.0) 
    voice "audio/voice/reika/chapter1/chapter1_3/reika_1_3_009.mp3"
    ...
    en "But their physical characteristics are completely different." with dissolve
    hide reika
    hide maya
    ...
    en "It's said that people confess their love to her regularly." with dissolve
    hide maya
    show reika normal at center with Dissolve(1.0) 
    ...
    voice "audio/voice/risa/chapter1/chapter1_3/risa_1_3_003.mp3"
    ...
    voice "audio/voice/risa/chapter1/chapter1_3/risa_1_3_004.mp3"
    ...
    en "Out of nowhere, I get a hard pinch on my waist." with dissolve
    ...
    voice "audio/voice/reika/chapter1/chapter1_3/reika_1_3_017.mp3"
    ...
    voice "audio/voice/risa/chapter1/chapter1_3/risa_1_3_005.mp3"
    ...
    hide risa
    show reika normal at zoom_in,center with Dissolve(1.0) 
    voice "audio/voice/reika/chapter1/chapter1_3/reika_1_3_021.mp3"
    ...
    hide risa
    th "แย่แล้ว ข้อต่อไปนี่มันข้อไหนล่ะเนี่ย เมื่อกี้กำลังจะหลับ" with dissolve
    ...
    hide reika
    show risa normal at center with Dissolve(1.0) 
    voice "audio/voice/risa/chapter1/chapter1_3/risa_1_3_007.mp3"
    ...
    hide risa
    show reika normal at zoom_in,center with Dissolve(1.0) 
    voice "audio/voice/reika/chapter1/chapter1_3/reika_1_3_022.mp3"
