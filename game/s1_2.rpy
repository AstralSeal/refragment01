label s1_2: 
    ...
    th "ตอนนี้ผมก็มาถึงโรงเรียนแล้ว" with dissolve
    en "Now I've arrived at school." with dissolve
    th "ต้องขอบคุณคุณพ่อที่เลือกซื้อบ้านใกล้กับโรงเรียน" with dissolve
    en "I have to thank my father for choosing a house so close to school." with dissolve
    th "จากบ้านถึงโรงเรียนใช้เวลาประมาณ 10 นาที ทำให้ผมนอนดึกและตื่นสายได้" with dissolve
    en "It takes about 10 minutes from home to school, allowing me to sleep late and wake up late." with dissolve
    show akane normal at center with Dissolve(1.0) 
    voice "audio/voice/akane/chapter1/chapter1_2/akane_1_2_001.mp3"
    akane_th ah "รุ่นพี่ยูมะ มาพอดีเลย" with dissolve
    akane_en ah "Yuuma-senpai, perfect timing!" with dissolve
    voice "audio/voice/akane/chapter1/chapter1_2/akane_1_2_002.mp3"
    akane_th normal "รองประธานฯ ฝากบอกมาว่าให้รุ่นพี่ยูมะไปที่หอประชุมด่วน" with dissolve
    akane_en normal "The vice president asked me to tell you to go to the auditorium right now." with dissolve
    yuma_th  "เข้าใจแล้ว" with dissolve
    yuma_en  "Roger that." with dissolve
    th "นักเรียนคนอื่นเมื่อมาถึงโรงเรียนก็จะทยอยเข้าไปที่ห้องเรียนของตัวเอง" with dissolve
    en "Other students, upon arriving at school, gradually head to their own classrooms." with dissolve
    hide akane
    th "แต่เนื่องจากผมทำงานอยู่สังกัดสภานักเรียน" with dissolve
    en "Since I am a student council member," with dissolve
    th "ผมจึงต้องช่วยงานกิจกรรมต่างๆ ของสภานักเรียนด้วย" with dissolve
    en "I've got to help out with a bunch of student council stuff too." with dissolve
    th "ส่วนผู้หญิงคนนี้ ถึงยามปกติจะดูเป็นคนเรียบร้อย" with dissolve
    ...
    akane_th  "นักเรียนชายตรงนั้น หยุดก่อน ช่วยแต่งตัวให้เรียบร้อยหน่อย" with dissolve
    akane_en  "Over there, stop! Please fix your uniform." with dissolve
    student_m_a_th  "ครับ!" with dissolve
    student_m_a_en  "Yes, ma'am!" with dissolve
    th "เธอคนนี้คืออิวาโนะ อากาเนะ เป็นกรรมการฝ่ายระเบียบวินัย" with dissolve
    en "The girl in front of me is Iwano Akane, a Disciplinary Committee member." with dissolve
    th "ทำหน้าที่ตรวจตราและดูแลความเรียบร้อยของนักเรียนทุกคน" with dissolve
    ...
    stop music
    play music "audio/bgm/MusMus-BGM-107.mp3" volume 0.5
    th "เนื่องจากผมยังไม่มีธุระอะไรกับอากาเนะในตอนนี้" with dissolve
    en "Since I don't have any business with Akane right now," with dissolve
    th "ผมจึงรีบไปที่หอประชุมตามที่รองประธานฯ บอกมา" with dissolve
    en "I hurry to the auditorium as the vice president instructed." with dissolve
    ...
    kazuma_en ah "Can you help set up the auditorium's lighting system?" with dissolve
    ...
    th "อีกทั้งเป็นลูกชายของนักการเมืองชื่อดัง ด้วยเหตุนี้จึงเป็นที่ชื่นชอบของบรรดาสาวๆ ในโรงเรียน" with dissolve
    en "Moreover, he's the son of a famous politician, which makes him popular among the girls at school." with dissolve
    yuma_th  "งานแถลงการณ์เริ่มเมื่อไหร่" with dissolve
    yuma_en  "When does the announcement start?" with dissolve
    voice "audio/voice/kazuma/chapter1/chapter1_2/kazuma_1_2_002.mp3"
    kazuma_th normal "อีก 10 นาที ยังมีเวลาเหลือเฟือ" with dissolve
    kazuma_en normal "In 10 minutes. We still have plenty of time." with dissolve
    yuma_th  "โอเค เข้าใจแล้ว" with dissolve
    yuma_en  "Okay, got it." with dissolve
    voice "audio/voice/akane/chapter1/chapter1_2/akane_1_2_004.mp3"
    akane_th ah "นักเรียนทุกคนมากันหมดแล้ว พร้อมหรือยัง" with dissolve
    akane_en ah "All the students are here. Are we ready?" with dissolve
    yuma_th  "พร้อมแล้ว ไม่มีปัญหา" with dissolve
    yuma_en  "Ready. No problems." with dissolve
    voice "audio/voice/kazuma/chapter1/chapter1_2/kazuma_1_2_003.mp3"
    kazuma_th smile "ถ้าอย่างนั้นก็เริ่มเลย" with dissolve
    kazuma_en smile "If that's the case, let's begin." with dissolve
    th "......" with dissolve
    en "......" with dissolve
    hide kazuma
    scene school_conventionhall_limelight with Dissolve(1.0)
    play sound "audio/sfx/スポットライトが当たる.mp3"
    th "......" with dissolve
    en "......" with dissolve
    play sound "audio/sfx/スポットライトが当たる.mp3"
    th "......." with dissolve
    ...
    th "เมื่อม่านเปิดขึ้นก็เผยให้เห็นภาพของหญิงสาวยืนอยู่บนโพเดี้ยม" with dissolve
    en "When the curtain opened, it revealed the image of a young woman standing at the podium." with dissolve
    student_f_a_th  "ท่านเรกะเท่ที่สุด สมกับเป็นประธานนักเรียนของพวกเรา" with dissolve
    ...
    reika_th  "สวัสดีทุกคน ฉันชื่อคุโรมิยะ เรกะ ประธานนักเรียนของโรงเรียนเอกชนซิลเวอร์ซีล" with dissolve
    reika_en  "Good morning everyone. My name is Kuromiya Reika, the student council president of Silverseal Private Academy." with dissolve
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_002.mp3"
    reika_th  "นักเรียนใหม่บางคนอาจจะยังไม่ทราบประวัติความเป็นมาของโรงเรียนแห่งนี้" with dissolve
    reika_en  "Some new students may not yet know the history of this school." with dissolve
    #todo
    #play sound "audio/sfx/[SFX - เสียงคนคุยกันในที่สาธารณะ].mp3"
    ...
    student_m_b_en  "Yeah, she's saying the same thing. I could recite it by now." with dissolve
    voice "audio/voice/akane/chapter1/chapter1_2/akane_1_2_005.mp3"
    akane_th  "นักเรียนชายตรงนั้น ที่นี่คือหอประชุม โปรดอย่าส่งเสียงดังรบกวน" with dissolve
    ...
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_009.mp3"
    reika_th  "นักเรียนทุกคนมีสิทธิ์ในการลงคะแนนเสียงในญัตติต่างๆ ซึ่งนโยบายที่ได้รับคะแนนโหวตสูงที่สุดจะถูกนำไปปฏิบัติและมีผลบังคับใช้จริง" with dissolve
    reika_en  "Every student has the right to vote on various motions, and the policy that receives the highest number of votes will be implemented and enforced." with dissolve
    ...
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_012.mp3"
    reika_th  "โรงเรียนซิลเวอร์ซีลมีเครื่องดื่มจำหน่ายมากมาย หนึ่งในนั้นคือน้ำอัดลม" with dissolve
    reika_en  "Silverseal Private Academy sells many beverages, one of which is soda." with dissolve
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_013.mp3"
    reika_th  "ไม่ปฏิเสธว่าน้ำอัดลมทำให้สดชื่น กระปรี้กระเปร่า ดับกระหายคลายร้อนได้เป็นอย่างดี" with dissolve
    reika_en  "I don't deny that soda makes you feel refreshed, energized, and quenches your thirst in hot weather." with dissolve
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_014.mp3"
    reika_th  "แต่ในขณะเดียวกัน การดื่มน้ำอัดลมมากเกินไปจะก่อให้เกิดโทษต่อสุขภาพร่างกาย" with dissolve
    reika_en  "However, at the same time, drinking too much soda can be harmful to your health." with dissolve
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_015.mp3"
    reika_th  "น้ำอัดลมไม่ว่ายี่ห้อไหนก็ประกอบด้วยน้ำ น้ำตาล กรดคาร์บอนิก กรดฟอสฟอริก คาเฟอีน สารแต่งสี สารแต่งกลิ่น รวมไปถึงสารกันบูด" with dissolve
    ...
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_018.mp3"
    reika_th  "โรงเรียนซิลเวอร์ซีลมีน้ำอัดลมหลายยี่ห้อวางจำหน่ายอยู่ แต่สมาคมศิษย์เก่าเสนอว่าควรยกเลิกการจำหน่ายน้ำอัดลมในพื้นที่โรงเรียนถาวร" with dissolve
    reika_en  "Silverseal Private Academy has many brands of soda for sale, but the Alumni Association proposes that we should permanently ban the sale of soda on school grounds." with dissolve
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_019.mp3"
    reika_th  "นักเรียนทุกท่านมีความเห็นอย่างไร ควรอนุญาตให้จำหน่ายน้ำอัดลมต่อ หรือยกเลิกการจำหน่ายน้ำอัดลมถาวร โปรดลงคะแนนเสียงภายในสัปดาห์นี้" with dissolve
    reika_en  "What do you all think? Should we continue to allow soda sales, or permanently ban soda sales? Please cast your votes within this week." with dissolve
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_020.mp3"
    reika_th  "ขอจบการนำเสนอเพียงเท่านี้ ใครมีคำถามอะไรไหม" with dissolve
    reika_en  "That concludes the presentation. Does anyone have any questions?" with dissolve
    scene school_conventionhall_lightoff with Dissolve(1.0)
    th "หลังเรกะพูดจบ หอประชุมตกอยู่ในความเงียบสงบ" with dissolve
    en "After Reika finished speaking, the auditorium fell into silence." with dissolve
    th "จนกระทั่งเสียงหนึ่งทำหลายความเงียบขึ้นมา" with dissolve
    en "Until one voice rang out, practically shattering the tense air that hung over the silent hall." with dissolve
    student_m_b_th  "คุณคุโรมิยะมีแฟนหรือยังครับ ช่วยบอกสเปคผู้ชายที่ชอบหน่อยครับ" with dissolve
    student_m_b_en  "Kuromiya-san, do you have boyfriend? Can you tell us what type of guy you like?" with dissolve
    play sound "audio/sfx/歓声と拍手1.mp3"
    ...
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_022.mp3"
    reika_th  "ที่นี่คือหอประชุม พื้นที่สาธารณะที่ทุกคนใช้งานร่วมกัน" with dissolve
    reika_en  "This is the auditorium, a public space that everyone uses together." with dissolve
    voice "audio/voice/reika/chapter1/chapter1_2/reika_1_2_023.mp3"
    reika_th  "ไม่มีสุภาพบุรุษที่ดีคนไหนโผงผางเรื่องส่วนตัวกลางพื้นที่สาธารณะหรอกนะ" with dissolve
    reika_en  "No true gentleman would blurt out personal matters in a public space." with dissolve
    student_m_b_th  "อะเฮือก!" with dissolve
    ...
    th "พอพูดจบ นักเรียนทุกคนก็ทยอยเดินออกจากหอประชุม" with dissolve
    en "After she finished speaking, all the students gradually walked out of the auditorium." with dissolve
    ...
    yuma_en  "The other day, someone slipped a love letter into a stack of documents. When Reika saw it, she tossed it straight into the paper shredder without hesitation." with dissolve
    student_m_b_th  "ดูท่าทางจะหมดหวังแล้วพวกเรา" with dissolve
    student_m_b_en  "Looks like we're out of options." with dissolve
    th "ระหว่างตัวแทนหมู่บ้านกับลิ่วล้อกำลังคุยเรื่องเรกะ ผมหันไปเห็นผู้หญิงคนหนึ่งทำท่าพะว้าพะวังหน้าตู้กดน้ำ" with dissolve
    en "While the real deal guy and his friends were talking about Reika-san, I turned to see a girl looking confused in front of the vending machine." with dissolve
    stop music
    play music "audio/bgm/MusMus-BGM-127.mp3" volume 0.5
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_001.mp3"
    show flyingseal01 with dissolve
    maya_0_th  "ตู้กดน้ำนี้มันใช้งานยังไงเนี่ย" with dissolve
    maya_0_en  "I wonder how to use this vending machine?" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_002.mp3"
    maya_0_th  "เอ๊ะ หน้าจอทัชสกรีนด้วยเหรอ" with dissolve
    maya_0_en  "Eh, It's a touch screen?" with dissolve
    play sound "audio/sfx/決定ボタンを押す28.mp3"
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_003.mp3"
    maya_0_th  "กดปุ่มนี้...... หรือว่าปุ่มนี้......" with dissolve
    maya_0_en  "Do I have to press this button... or that button?" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_004.mp3"
    maya_0_th  "ใช้ยากชะมัด ทำไมไม่ทำปุ่มกดให้มันใช้ง่ายๆ กันเล่า" with dissolve
    maya_0_en  "It's so difficult to use. I prefer traditional vending machine with real mechanical buttons." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_005.mp3"
    maya_0_th  "จริงด้วย คิดออกแล้ว" with dissolve
    maya_0_en  "Ah ha~ I got an idea." with dissolve
    stop music
    play music "audio/bgm/MusMus-BGM-119.mp3" volume 0.5
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_006.mp3"
    ...
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_007.mp3"
    hide flyingseal01 with dissolve
    maya_0_th  "ย้ากกกกกก!" with dissolve
    maya_0_en  "Yaaaah!" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_008.mp3"
    maya_0_th  "แปลกจัง ทำไมกระป๋องน้ำถึงไม่หล่นลงมาแบบในอนิเมะ" with dissolve
    maya_0_en  "Why didn't the drink can fall out like in the anime I watched?" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_009.mp3"
    maya_0_th  "สงสัยออกแรงน้อยไปหน่อย" with dissolve
    maya_0_en  "Maybe I didn't kick it hard enough." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_010.mp3"
    maya_0_th  "ดีล่ะ รอบนี้ได้แน่นอน คงต้องใช้เทคนิคขั้นสูงกันสักหน่อยแล้ว" with dissolve
    maya_0_en  "Alright, I guess I'll have to use an advanced technique." with dissolve
    play sound "audio/sfx/背負い投げ2.mp3"
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_011.mp3"
    show kick04 with dissolve
    maya_0_th  "รับไปซะ ลูกเตะอัคคีสลาตัน!" with dissolve
    maya_0_en  "Take this, Fire Tornado!" with dissolve
    hide kick01 with dissolve
    th "จะบ้าเหรอ นี่มันตู้กดน้ำ ไม่ใช่ลูกบอล" with dissolve
    en "Stop! This is not a football match, are you out of mind?" with dissolve
    hide kick04 with dissolve
    th "ผมรีบเข้าไปห้ามก่อนที่จะเกิดความเสียหายมากไปกว่านี้" with dissolve
    en "I hurried to stop her before the vending machine broke." with dissolve
    yuma_th  "เดี๋ยวสิ ทำอะไรของเธอเนี่ย" with dissolve
    yuma_en  "Stop! What are you doing?" with dissolve
    stop music
    play music "audio/bgm/MusMus-BGM-034.mp3" volume 0.5
    show maya normal at center with Dissolve(1.0) 
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_012.mp3"
    maya_0_th ah "อ๊ะ คนจากสภานักเรียนใช่มั้ย พอดีเลย นายมานี่หน่อยสิ" with dissolve
    maya_0_en ah "Oh, you're the student council member, right? Please come here for a sec." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_013.mp3"
    maya_0_th angry "ตู้เสียแน่เลย กดปุ่มแล้วไม่เห็นมีน้ำออกมาเลย" with dissolve
    maya_0_en angry "The machine is broken. I pressed the button but nothing came out." with dissolve
    yuma_th  "ตู้ไม่ได้เสียซักหน่อย เธอน่ะใช้ตู้ผิดวิธีต่างหาก" with dissolve
    yuma_en  "The machine is working perfectly fine. You don't know how to use it, right?" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_014.mp3"
    ...
    yuma_en  "It serves drinks in glasses, not cans nor bottles like regular vending machines." with dissolve
    yuma_th  "นอกจากนี้ยังเลือกประเภทเครื่องดื่ม ร้อน-เย็น-ปั่น ได้มากกว่า 180 เมนูเลยทีเดียว" with dissolve
    yuma_en  "Moreover, you can choose from over 180 menus of hot, cold, or even blended drinks." with dissolve
    yuma_th  "เนื่องจากมีเมนูเครื่องดื่มให้เลือกเยอะมาก จึงต้องสั่งงานผ่านหน้าจอสัมผัสขนาดใหญ่" with dissolve
    yuma_en  "Because there are a lot of drinks and options to choose, you have to order by using a large touch screen in front of the machine." with dissolve
    yuma_th  "วิธีใช้ไม่ยาก เลือกเมนูที่ต้องการ เลือกระดับความหวานและจ่ายเงิน ทำตามขั้นตอนได้เลย" with dissolve
    yuma_en  "It's not that difficult. Just swipe a screen to select your preferred menu, choose the sweetness level, and pay the money. Follow the steps." with dissolve
    show maya ah_2 at center
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_015.mp3"
    hide flyingseal05 with dissolve
    maya_0_th ah_2 "ว้าว จริงด้วย ใช้งานไม่ยากอย่างที่คิดแฮะ" with dissolve
    maya_0_en ah_2 "Wow! It's not as difficult to use as I imagined." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_016.mp3"
    maya_0_th  "นี่นายเป็นพนักงานบริษัทผลิตตู้เครื่องดื่มที่ปลอมตัวมาเป็นนักเรียนหรือเปล่าเนี่ย" with dissolve
    maya_0_en  "By the way, are you a vending machine salesman disguised as a student?" with dissolve
    yuma_th  "จริงๆ แล้วผมเป็นประธานบริษัท! ……ไม่ใช่ จะเป็นแบบนั้นได้ยังไงเล่า!?" with dissolve
    yuma_en  "Actually, I'm the CEO! ... Just kidding, there's no way that could be true!" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_017.mp3"
    ...
    maya_0_en confident "Even the police can disguise themselves as Korean fried chicken shop owners. So, it's not surprising if you're disguised as a student." with dissolve
    yuma_th  "ผมเป็นแค่นักเรียนธรรมดา ไม่ใช่ตำรวจสักหน่อย" with dissolve
    yuma_en  "I AM ordinary student, definitely not a police officer." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_018.mp3"
    ...
    maya_0_en serious "Could it be... a student who has infiltrated the school to hunt down suspicious Astral Ability users." with dissolve
    yuma_th  "แล้วความลับก็รั่วไหลโดยผู้หญิงผมสีชมพูที่สวมแผ่นเสริมหน้าอก" with dissolve
    yuma_en  "And your true identity was revealed to pink-haired girl wearing a chest pad." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_019.mp3"
    ...
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_020.mp3"
    ...
    yuma_en  "Just press the button and customize the drink as you like." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_021.mp3"
    maya_0_th ah_2 "งั้นฉันเอาอันนี้ละกัน... เลือกระดับความหวาน……?" with dissolve
    maya_0_en ah_2 "Alright, I'll take this one... Hmm, please select sweetness level?" with dissolve
    show maya normal at zoom_in,center with Dissolve(1.0) 
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_022.mp3"
    maya_0_th fun "จัดไปเต็มพิกัด ระดับความหวาน 140\%" with dissolve
    maya_0_en fun "Okay, Maximum sweetness level: 140\%." with dissolve
    ...
    maya_0_en angry "Talking about weight with a young girl like me is really impolite. You just don't understand how women feel at all." with dissolve
    hide angry
    yuma_th  "มันร้ายแรงขนาดนั้นเลยเหรอ?" with dissolve
    yuma_en  "Is it really that serious?" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_024.mp3"
    maya_0_th hee2_2 "ใช่นะสิ ถ้าไม่เปลี่ยนวิธีพูด ระวังจะไม่มีแฟนไปตลอดชีวิตนะ" with dissolve
    maya_0_en hee2_2 "Absolutely. If you don't change the way you talk, be careful, you might not have a girlfriend for your entire life." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_025.mp3"
    maya_0_th smile_2 "แต่ว่าตอนนี้นายยังมีโอกาสแก้ตัวอยู่นะ" with dissolve
    maya_0_en smile_2 "But you still have a chance to turn things around now." with dissolve
    yuma_th  "โอกาสแก้ตัว?" with dissolve
    yuma_en  "A chance?" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_026.mp3"
    maya_0_th confident2 "ใช่แล้ว ถ้านายเลี้ยงน้ำฉัน ไม่แน่ว่าค่าความชอบของฉันอาจจะเพิ่มขึ้นก็ได้น้า~" with dissolve
    maya_0_en confident2 "Yes. If you treat me to a drink, my affection rate for you might increase, you know~" with dissolve
    ...
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_027.mp3"
    maya_0_th pero "ถูกจับได้ซะแล้ว แหะๆ" with dissolve
    maya_0_en pero "Teehee~" with dissolve
    show maya normal at center with Dissolve(1.0) 
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_028.mp3"
    maya_0_th ah_2 "ว่าแต่นายชื่ออะไรนะ จำได้แค่อยู่ในสภานักเรียน ไม่คุ้นชื่อเลย" with dissolve
    maya_0_en ah_2 "By the way, what's your name? I only remember you're from the student council, but I can't remember who you are." with dissolve
    ...
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_033.mp3"
    maya_th huh "นายอยู่สังกัดสภานักเรียนสินะ ช่วยไปบอกคนในสภานักเรียนหน่อยว่าฉันไม่เอาด้วยหรอก" with dissolve
    maya_en huh "You're part of the student council, right? Can you let the student council committee know that I'm not okay with this?" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_034.mp3"
    ...
    maya_en  "How can they suddenly ban soda drinks? If they can ban soda sales today, tomorrow they might ban tea and coffee. I completely disagree with this." with dissolve
    yuma_th  "แต่งานวิจัยบอกว่าน้ำอัดลมไม่ดีต่อสุขภาพนะ" with dissolve
    yuma_en  "But research shows that soda is bad for your health." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_035.mp3"
    maya_th angry "มันก็จริง แต่ว่าถ้าใครอยากดื่มน้ำอัดลมก็ดื่ม ไม่อยากดื่มก็ไม่ต้องดื่ม ไม่เห็นยากเลย" with dissolve
    maya_en angry "That's true, but if you wants to drink soda, you can drink it, and vice versa. It's not that complicated." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_036.mp3"
    ...
    yuma_en  "If it were another school, the teachers or the board would have already enforced the new rules." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_037.mp3"
    maya_th normal_2 "ว่าแต่ยูคุง นายคิดยังไงกับเรื่องนี้" with dissolve
    maya_en normal_2 "By the way, Yuu-kun, what do you think about this?" with dissolve
    ...
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_038.mp3"
    ...
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_039.mp3"
    maya_th serious "โยนเรื่องกฎระเบียบทิ้งไปก่อน ฉันถามความคิดเห็นของนาย" with dissolve
    maya_en serious "Forget about rules and regulations for a moment. I want to know your opinion." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_040.mp3"
    ...
    maya_en hurt_2 "{size=-14}Oh no, I suddenly sense something dangerous.{/size}" with dissolve
    th "รุ่นพี่มายะพูดพึมพำอะไรสักอย่าง" with dissolve
    en "Maya-senpai mumbled something." with dissolve
    yuma_th  "เมื่อกี้เธอว่าอะไรนะ" with dissolve
    yuma_en  "What did you just say?" with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_043.mp3"
    maya_th shy2 "ปะ… เปล่า" with dissolve
    maya_en shy2 "N-Nothing." with dissolve
    voice "audio/voice/maya/chapter1/chapter1_2/maya_1_2_044.mp3"
    maya_th wink "ฉันต้องรีบไปแล้ว ไว้เจอกันใหม่นะ ขอบใจมาก ยูคุง~" with dissolve
    maya_en wink "I have to hurry now. See you later, thanks a lot, Yuu-kun~" with dissolve
    play sound "audio/sfx/家の階段を駆け上る.mp3"
    th "หลังพูดจบ มายะก็รีบวิ่งขึ้นบันไดพร้อมกับแก้วเครื่องดื่มจากตู้แมวน้ำบิน" with dissolve
    ...
    show akane normal at center with Dissolve(1.0) 
    voice "audio/voice/akane/chapter1/chapter1_2/akane_1_2_006.mp3"
    akane_th angry "เดี๋ยวเถอะ อย่าวิ่งบริเวณทางเดินนะ!" with dissolve
    akane_en angry "Wait! Don't run in the hallway!" with dissolve
    voice "audio/voice/akane/chapter1/chapter1_2/akane_1_2_007.mp3"
    akane_th angrymeme "อย่าหนีนะ …ให้ตายเถอะ ตามไม่ทันจนได้" with dissolve
    akane_en angrymeme "Don't run away... Damn it, I couldn't catch up." with dissolve
    voice "audio/voice/akane/chapter1/chapter1_2/akane_1_2_008.mp3"
    akane_th angry "รุ่นพี่ยูมะ ทำไมรุ่นพี่ถึงไม่ตักเตือนคุณชิราซากิคะ นอกจากวิ่งบริเวณทางเดินแล้วยัยนั่นยังแต่งตัวผิดระเบียบหัวจรดเท้าอีกต่างหาก" with dissolve
    akane_en angry "Yuuma-senpai, why didn't you warn Shirasaki-senpai? Not only was she running in the hallway, but her uniform breaks nearly every regulation there is." with dissolve
    yuma_th  "ขอโทษคร้าบ ครั้งหน้าจะรีบตักเตือน" with dissolve
    ...
    voice "audio/voice/akane/chapter1/chapter1_2/akane_1_2_009.mp3"
    ...
    en "I see. So Maya-senpai ran away in a hurry earlier because she saw Akane." with dissolve
    hide akane
