label s2_2:
    ...
    yuma_en  "Good morning, Senior Maya." with dissolve
    ...
    maya_en yasashi "No one dares to argue with that little miss disciplinary committee. As far as I can see, you're the only one." with dissolve
    th "พอลองคิดดูแล้วก็จริงอย่างที่รุ่นพี่มายะพูด ไม่เคยมีใครโต้แย้งอากาเนะได้สำเร็จ" with dissolve
    en "Thinking about it, Senior Maya is right. No one has ever successfully argued with Akane." with dissolve
    hide maya
    ...
    yuma_en  "A million?! Senior!!!" with dissolve
    ...
    en "Suddenly, Senior Maya stops talking abruptly." with dissolve
    ...
    yuma_en  "This is Senior Maya's student ID. She must have dropped it while running from Akane earlier." with dissolve
    ...
    yuma_en  "No, I've been watching too many movies. Calm down, Yuma. Take a deep breath." with dissolve
    ...
    yuma_en  "That's impossible. Silver Seal Private School is co-ed, not an all-girls school." with dissolve
    yuma_th  "คงไม่มีเหตุการณ์ชายแต่งหญิงแบบในเกมวิชวลโนเวลที่เคยเล่นหรอกมั้ง" with dissolve
    yuma_en  "There's no way we'd have a boy-dressing-as-girl scenario like in those visual novel games I've played." with dissolve
