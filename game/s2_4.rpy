label s2_4:
    ...
    risa_en question "" with dissolve
    ...
    show kazuma normal at right with Dissolve(1.0) 
    ...
    en "" with dissolve
    th "อาจเขียนบนหน้าจอบอกผู้เล่นว่า Hint - คุณสามารถย้อนกลับไปดูข้อความก่อนหน้าได้ด้วยการกดปุ่ม Backlog" with dissolve
    en "" with dissolve
    ...
    reika_en angry_2 "" with dissolve
    ###########shortcut########ON
    ...
    reika_en angrymeme_2 "" with dissolve
    ...
    hide reika
    show risa normal at center with Dissolve(1.0) 
    show risa normal at left with Dissolve(1.0) 
    ...
    yuma_en  "" with dissolve
    hide reika
    show kazuma normal at left with Dissolve(1.0) 
    show akane normal at right with Dissolve(1.0) 
    ...
    yuma_en  "" with dissolve
    th "ตัดฉาก - time skip หลังกินข้าวเย็น" with dissolve
    en "" with dissolve
    ...
    yuma_en  "" with dissolve
    hide reika
    show akane normal at left with Dissolve(1.0) 
    show risa normal at right with Dissolve(1.0) 
    ...
    reika_en shy_2_shy "" with dissolve
    ...
    reika_th normal "ถ้าเกิดจะให้มีความรักก็ต้องเป็นความรักที่บริสุทธิ์อย่างรักแรกพบ ต่างคนต่างแอบชอบซึ่งกันและกันแล้วสุดท้ายก็ได้รักกัน" with dissolve
    reika_en normal "" with dissolve
    ...
    reika_en bored_2 "" with dissolve
    ...
    kazuma_th  "จะว่าไป ไม่คิดเลยว่าจะได้เจอนายที่โซนจำหน่ายอุปกรณ์กีฬาด้วย สนใจเข้าชมรมมั้ย" with dissolve
    kazuma_en  "" with dissolve
    ...
    kazuma_en confident "" with dissolve
    ...
    en "" with dissolve
    th "Background - หน้าห้างฯ ตอนกลางคืน" with dissolve
    en "" with dissolve
    ...
    en "" with dissolve
    th "Background - ถนนตอนกลางคืน" with dissolve
    en "" with dissolve
    ...
    reika_th angry "ไม่ใช่แบบนั้นสักหน่อย แต่พอโตขึ้น ความรับผิดชอบยิ่งมากขึ้น เอาแต่เล่นสนุกทั้งวันเหมือนเมื่อก่อนไม่ได้แล้ว" with dissolve
    reika_en angry "" with dissolve
    ...
    en "" with dissolve
    th "ด้วยเหตุนี้จึงเลือกรับตำแหน่งเหรัญญิกที่เน้นการอ่านและคำนวณข้อมูล" with dissolve
    en "" with dissolve
    th "ไม่ต้องออกไปพูดต่อหน้าคนจำนวนมาก" with dissolve
    en "" with dissolve
